package com.ritorno.geoblocks.chat.Fragments;
...
import com.ritorno.geoblocks.chat.Adapter.UserAdapter;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if("cJnpaBPrNEOdzkz8Awa6nzoUOef1".equals(chat.getSender())){
                        userslist.add(chat.getReceiver());
                    }
                    if("cJnpaBPrNEOdzkz8Awa6nzoUOef1".equals(chat.getReceiver())){
