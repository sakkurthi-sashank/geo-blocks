package com.ritorno.geoblocks.avatar
...
import com.ritorno.geoblocks.MapActivity
...
class AvatarActivity : AppCompatActivity(), WebViewActivity.WebViewCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragmentTransaction.replace(R.id.Home_Activity_Fragment_Container, CodeAssistFragment())
        fragmentTransaction.commit()

        val createbtn = this.findViewById<Button>(R.id.create_button)
        val backBtn = this.findViewById<Button>(R.id.back_btn_avatar)
