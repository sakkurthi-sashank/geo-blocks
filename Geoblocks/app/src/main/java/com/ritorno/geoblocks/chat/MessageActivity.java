...
import com.ritorno.geoblocks.chat.Adapter.MessageAdapter;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(view -> {
            ...
            if(!msg.equals("")){
                sendMessage("cJnpaBPrNEOdzkz8Awa6nzoUOef1",userid,msg);
            }else{
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                readMessages("cJnpaBPrNEOdzkz8Awa6nzoUOef1",userid,user.getImageURL());
        ...
        seenListener = reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    assert chat != null;
                    if(chat.getReceiver().equals("cJnpaBPrNEOdzkz8Awa6nzoUOef1")&&chat.getSender().equals(userid)){
